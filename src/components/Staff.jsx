    ...
    if (animationState === "running") {
      ...
      let timeout = setTimeout(() => {
        ...
        animation = setInterval(() => {
          ...
          const targetBox = document.getElementsByClassName("target-box");
          ...
          const targetItem2id = parseInt(targetItem2.getAttribute("id"));
          const noteDivs2 = targetItem2.querySelectorAll(".note");
          let targetcontainer =
            document.getElementsByClassName("note-container")[idsToPlay[0]];
          ...
          if (
            ...
            if (
              ...
              notesToPlay.splice(notesToPlay.indexOf(notesPressed[0]), 1);
              ...
              notesPressed.splice(notesPressed.indexOf(notesPressed[0]), 1);
            } else {
              targetcontainer
          ...
          if (
            ...
            noteDivs2.forEach((noteDiv) => {
              ...
              notesToPlay.push(noteDiv.classList[1].slice(-7, -5));
            });
          }
          const targetItem1id = parseInt(targetItem1.getAttribute("id"));
          if (targetItem1id > startingId) {
            startingId = targetItem1id;
          }

          if (targetcontainer.id == startingId && idsToPlay[0] == startingId) {
            targetcontainer.querySelectorAll(".wrong")[0].classList.add("show");
            console.log("isfired");
...
*/
  ...
  function randomIndex() {
    if (primaryClef == "treble")
      return Math.floor(
        Math.random() * (localTrebleUpperLimit - localTrebleLowerLimit + 1) +
          localTrebleLowerLimit
      );
    if (primaryClef == "bass")
      return Math.floor(
        Math.random() * (localBassUpperLimit - localBassLowerLimit + 1) +
          localBassLowerLimit
      );
  }
    ...
    <>
      ...
      {showSettings && (
        <div className='settings'>
          ...
          <div className='settings-limit'>
            <h1 className='limits-text' htmlFor='treble-function-select'>
              Select a function:
            </h1>
            <select
              ...
              {trebleFunctionList.map((option, index) => (
                <option key={option.value} value={option.value} index={index}>
                  {option.label}
                </option>
              ))}
            </select>
          ...
          <div className='settings-limit'>
            ...
            <input
              className='songlength-input'
              type='number'
              onChange={(e) => setBassNoteFrequency(e.target.value)}
          ...
          <div className='settings-limit'>
            ...
            <select
              ...
              {trebleUpperLimitOptions.map((option, index) => (
                <option key={option.Treblenote} value={option.Trebleid}>
                  {option.Treblenote.slice(-2)}
                </option>
              ))}
            </select>
        ...
        <div className='greater-container'>
          ...
          <div
            ...
            {songpattern.map((songpattern, index) => {
              return (
                <div className='note-container' key={index} id={index}>
                  ...
                  <div
                    ...
                    <img
                      ...
                      data-value={0}
                    />
                    <svg className='note-name' viewBox='0 0 30 30'>
                      <text x='0' y='15'>
                        {checked &&
                          songpattern.Treblenote.slice(
                            songpattern.Treblenote.length - 2,
                            songpattern.Treblenote.length
                          )}
                      </text>
                    </svg>
                  </div>
                        ...
                        <text x='0' y='15'>
                          {checked &&
                            songpattern.Bassnote.slice(
                              songpattern.Bassnote.length - 2,
                              songpattern.Bassnote.length
                            )}
                        </text>
                      </svg>
                    </div>
                  ...
                  <div
                    className={classNames({
                      "C6-bar": songpattern.Treblenote === "TrebleC6",
                    })}></div>
                  <div
                    className={classNames({
                      "A5-bar":
                        songpattern.Treblenote === "TrebleB5" ||
                        songpattern.Treblenote === "TrebleA5" ||
                        songpattern.Treblenote === "TrebleC6",
                    })}></div>

                  <div
                    className={classNames({
                      "treble-C4-bar":
                        songpattern.Treblenote === "TrebleA3" ||
                        songpattern.Treblenote === "TrebleC4" ||
                        songpattern.Treblenote === "TrebleB3" ||
                        songpattern.Treblenote === "TrebleD4",
                    })}></div>
                  <div
                    className={classNames({
                      "A3-bar":
                        songpattern.Treblenote === "TrebleA3" ||
                        songpattern.Treblenote === "TrebleB2",
                    })}></div>
                  {/*bass bars*/}
                  <div
                    className={classNames({
                      "E4-bar":
                        songpattern.Bassnote === "BassD4" ||
                        songpattern.Bassnote === "BassE4",
                    })}></div>
                  <div
                    className={classNames({
                      "bass-C4-bar":
                        songpattern.Bassnote === "BassC4" ||
                        songpattern.Bassnote === "BassE4" ||
                        songpattern.Bassnote === "BassD4",
                    })}></div>
                  <div
                    className={classNames({
                      "E2-bar":
                        songpattern.Bassnote === "BassE2" ||
                        songpattern.Bassnote === "BassF2" ||
                        songpattern.Bassnote === "BassD2" ||
                        songpattern.Bassnote === "BassC2",
                    })}></div>
                  <div
                    className={classNames({
                      "C2-bar":
